...
exports.default = {
    ...
    dateFormatWithChinese: function dateFormatWithChinese(dateStr) {
        return dateStr ? new Date(dateStr).format('yyyy年MM月dd日 hh:mm:ss') : "";
    },
    dateFormatByMonth: function dateFormatByMonth(dateStr) {
        var type = this.language().login_flag,
            dateInfo = this.getDateNum(dateStr);
        if (type == 1) {
            return dateStr ? new Date(dateStr).format('yyyy-MM-dd') : "";
        }
        return dateStr ? dateInfo.month + '/' + dateInfo.day + '/' + dateInfo.year : '';
    },
    dateFormatByMonthWithChinese: function dateFormatByMonthWithChinese(dateStr) {
        var type = this.language().login_flag,
    ...
    dayFormat: function dayFormat(dataStr, type) {
        if (!dataStr) {
            return '';
        }
        if (!type) {
    ...
    getDateNum: function getDateNum(timestamp) {
    ...
    alertMessage: function alertMessage(desc, delay, callback) {
        var hasIcon = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;

        var time = 1500,
            doc = document,
            body = doc.body,
            h = 0,
            hints = doc.querySelector('.hint-popup'),
            timer1 = null,
            timer2 = null,
            icon = hasIcon;
    ...
    loading: function loading(flag, loadingText) {
        if (flag) {
            var loadingText = loadingText || "努力加载中...";
            var html = '<div class="loader-inner">' + '<img src="' + spinnerImg + '"/>' + '<p>' + loadingText + '</p></div>';
    ...
    ajaxRequest: function ajaxRequest(options) {
        ...
        var url = options.url,
            type = options.type,
            data = options.data,
            successCbk = options.successCbk,
            errorCbk = options.errorCbk,
            flagErrorCbk = options.flagErrorCbk;
        ...
        try {
            (0, _ajax2.default)(defaultOption).then(function (response) {
            ...
            }).catch(function (response, xhrObject) {
                var status = xhrObject.status;
                ...
                switch (+status) {
                    case 401:
                        _this.notLoginCallabck(true);
                        break;
                    case 400:
                    case 500:
                        _this.alertMessage("系统出错");
                        break;
                    default:
                        // 网络错误
                        _this.alertMessage("网络错误");
                        break;
                }
            });
        } catch (e) {
     ...
     * 未登录回调
     */
    notLogin: function notLogin(callabck) {
...
var _useBasename = __webpack_require__(116);
...
var _bottom = __webpack_require__(228);
...
//主页
var HomePage = function HomePage(nextState, cb) {
    __webpack_require__.e/* require.ensure */(0).then((function (require) {
        cb(null, __webpack_require__(231));
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function componentWillMount() {
            var _this = this;
            _util2.default.notLogin(function () {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                null,
                hasLogin ? _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.cloneElement(this.props.children, {
                        key: this.props.location.pathname
                    }),
                    _react2.default.createElement(_bottom2.default, { pathName: this.props.location.pathname })
                ) : _react2.default.createElement(_login2.default, { onLogin: function onLogin(bool) {
                        return _this3.handLogin(bool);
                    } })
            );
        }
    }, {
...
var Routers = _react2.default.createElement(
    ...
    _react2.default.createElement(
        _reactRouter.Route,
        { path: '/', component: App },
        _react2.default.createElement(_reactRouter.IndexRoute, { getComponent: HomePage }),
        _react2.default.createElement(_reactRouter.Route, { path: '/home-page', getComponent: HomePage }),
        _react2.default.createElement(_reactRouter.Route, { path: '/login', getComponent: _login2.default })
    )
);

// MobileHandle.setAjaxHeader();
_reactDom2.default.render(Routers, document.getElementById('app-container'));
...
var _createHashHistory = __webpack_require__(107);
...
var _createRouterHistory = __webpack_require__(118);
...
module.exports = {"hint-popup":"hint-popup","show":"show","hide-hint":"hide-hint","hide":"hide","icon":"icon","loader":"loader","loader-inner":"loader-inner","on":"on","off":"off"};
...
// removed by extract-text-webpack-plugin
module.exports = {"warning":"warning","price":"price","danger":"danger","normal":"normal","green":"green","main":"main","nolist":"nolist","fl":"fl","fr":"fr","clearFix":"clearFix","iconfont":"iconfont","hasFixed":"hasFixed","loader":"loader","line-scale-pulse-out":"line-scale-pulse-out","btn":"btn","primary":"primary","btn-danger":"btn-danger","_confirm":"_confirm","_confirm-frame":"_confirm-frame","_confirm-text":"_confirm-text","_c-main-text":"_c-main-text","_c-vice-text":"_c-vice-text","_confirm-operate":"_confirm-operate","hide":"hide"};
...
// removed by extract-text-webpack-plugin
module.exports = {"bottom-layout":"bottom-layout"};
